...
Disassembles the AMBLIST output that you are currently editing with ISPF/EDIT.
...
1. Tag the AMBLIST output (much more detail in the USAGE section below).
...
1. Assemble the disassembled source file. You will
...
1. As new instructions are added to the z/Series inst-
...
1. A handy way to initially tag the AMBLIST output is
...
1. Edit the SYSPRINT output (e.g. issue SE in SDSF)
...
1. Optionally, tag the hex more rigorously:
...
1. Examine the "Undefined labels" report at the end of the dis-
